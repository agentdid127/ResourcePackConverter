...
public class ParticleConverter extends Converter {
    ...
    public void convert(Pack pack) throws IOException {
        ...
        if (from <= Util.getVersionProtocol(packConverter.getGson(), "1.13.2") && to >= Util.getVersionProtocol(packConverter.getGson(), "1.14")) {
            ...
            iconvert.newImage(iconvert.getWidth() / 32, iconvert.getHeight() / 32);
            ...
            iconvert.newImage(iconvert.getWidth() / 16, iconvert.getHeight() / 16);
            ...
            iconvert.newImage(iconvert.getWidth() / 32, iconvert.getHeight() / 32);
            iconvert.subImage(40, 112, 4112, 120, 0 ,0);
            ...
            iconvert.newImage(iconvert.getWidth() / 32, iconvert.getHeight() / 32);
            iconvert.subImage(80, 112, 8112, 120, 0 ,0);
            ...
            iconvert.newImage(iconvert.getWidth() / 32, iconvert.getHeight() / 32);
            iconvert.subImage(120, 112, 12112, 120, 0 ,0);
