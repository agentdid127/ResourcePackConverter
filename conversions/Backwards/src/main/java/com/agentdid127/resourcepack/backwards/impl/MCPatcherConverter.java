...
public class MCPatcherConverter extends Converter {
    ...
    public void convert(Pack pack) throws IOException {
        Path models = pack.getWorkingPath().resolve("assets/minecraft/mcpatcher".replace("/", File.separator));
    ...
    protected String updateID(String type, PropertiesEx prop, String selection) {
        JsonObject id = JsonUtil.readJsonResource(packConverter.getGson(), "/backwards/ids.json").get(selection).getAsJsonObject();
