...
public class EnchantPathConverter extends Converter {
    ...
    public void convert(Pack pack) throws IOException {
        ...
        if (miscPath.resolve("enchanted_item_glint.png.mcmeta").toFile().exists()) {
            Files.copy(miscPath.resolve("enchanted_item_glint.png.mcmeta"), miscPath.resolve("enchanted_glint_entity.png.mcmeta"));
            Files.copy(miscPath.resolve("enchanted_item_glint.png.mcmeta"), miscPath.resolve("enchanted_glint_item.png.mcmeta"));
